...
export interface ApiArticuloArticulo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    portada: Attribute.Boolean &
      ...
      Attribute.DefaultTo<false>;
    etiquetas: Attribute.Component<'articulos.etiqueta', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSeccionSeccion extends Schema.CollectionType {
  ...
  attributes: {
    tituloSeccion: Attribute.String & Attribute.Required & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
